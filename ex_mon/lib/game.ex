defmodule ExMon.Game do
  ...
  def start(computer, player) do
    intital_value = %{computer: computer, player: player, turn: :player, status: :started}
    Agent.start_link(fn -> intital_value end, name: __MODULE__)
  end
  ...
  def fetch_opponent(opponent), do: Map.get(info(), opponent)
